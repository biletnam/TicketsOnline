...
<body>
    ...
    <div class="header-title ken-burn ken-burn-center" data-parallax="scroll" data-position="top" data-natural-height="670" data-natural-width="1300" data-image-src="../images/wide/<s:property value="id"/>.jpg">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="flexslider slider visible-dir-nav nav-inner">
                                <ul class="slides">
                                    <li>
                                        <a class="img-box img-scale-rotate lightbox grayscale" href="../images/gallery/mini/<s:property value="id"/>_1.jpg" data-lightbox-anima="show-scale">
                                            <img alt="" src="../images/gallery/mini/<s:property value="id"/>_1.jpg" />
                                        </a>
                                    </li>
                                    <li>
                                        <a class="img-box img-scale-rotate lightbox grayscale" href="../images/gallery/mini/<s:property value="id"/>_2.jpg" data-lightbox-anima="show-scale">
                                            <img alt="" src="../images/gallery/mini/<s:property value="id"/>_2.jpg" />
                                        </a>
                                    </li>
                                    <li>
                                        <a class="img-box img-scale-rotate lightbox grayscale" href="../images/gallery/mini/<s:property value="id"/>_3.jpg" data-lightbox-anima="show-scale">
                                            <img alt="" src="../images/gallery/mini/<s:property value="id"/>_3.jpg" />
                                        </a>
                                    </li>
                                    <li>
                                        <a class="img-box img-scale-rotate lightbox grayscale" href="../images/gallery/mini/<s:property value="id"/>_4.jpg" data-lightbox-anima="show-scale">
                                            <img alt="" src="../images/gallery/mini/<s:property value="id"/>_4.jpg" />
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-md-3">
                            <p>FLYER OFICIAL</p>
                            <a class="img-box lightbox" href="../images/flyer/<s:property value="id"/>_S.png" data-lightbox-anima="show-scale">
                                <img alt="" src="../images/flyer/<s:property value="id"/>_B.png">
                            </a>
                        </div>
                    </div>
                </div>
